...
class CatapultClient:
    ...
    def stats(
        ...
        group_by:   list of grouping dims, e.g. ["athlete", "team", "position"]
        """
        filters = []
        if activity_ids:
            filters.append({
...
# --- Tabs ------------------------------------------------------------------
tab_athletes, tab_activities, tab_activity_detail, tab_rankings, tab_compare, tab_acwr, tab_ask, tab_raw = st.tabs(
    ["Athletes", "Activities", "Activity Detail", "Rankings", "Compare", "ACWR", "Ask AI", "Raw GET"]
)
